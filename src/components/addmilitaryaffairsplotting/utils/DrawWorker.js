...
var DrawHelper = (function () {
    ...
    var defaultBillboard = {
        iconUrl: require('@/assets/image/img/dragIcon.png'),
        shiftX: 0,
        shiftY: 0
    }
    ...
    var dragHalfBillboard = {
        iconUrl: require('@/assets/image/img/dragIconLight.png'),
        shiftX: 0,
        shiftY: 0
    }
    ...
    _.DrawHelperWidget = (function () {
        ...
        function _(drawHelper, options) {
            ...
            var drawOptions = {
                markerIcon: require('@/assets/image/img/glyphicons_242_google_maps.png'),
                polylineIcon: require('@/assets/image/img/glyphicons_097_vector_path_line.png'),
                polygonIcon: require('@/assets/image/img/qianjijiantou.png'),
                circleIcon: require('@/assets/image/img/glyphicons_095_vector_path_circle.png'),
                tailedAttackArrowIcon: require('@/assets/image/img/gongjijiantou.png'),
                extentIcon: require('@/assets/image/img/zhijiaojiantou.png'),
                clearIcon: require('@/assets/image/img/glyphicons_067_cleaning.png'),
