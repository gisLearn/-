let distance_close = require('@/assets/image/map/distance_close.png');
let distance_end = require('@/assets/image/map/distance_end.png');
let distance_start = require('@/assets/image/map/distance_start.png');
 ...
 * 测量距离
 */
export var measureDistance = function (cesium) {
    var isDraw = false
    var polylinePath = []
    ...
    this.clear = function () {
        ...
        // // tooltip.style.display = 'block';
        // // tooltip.innerHTML = ''
        // if (billboards && entities.length > 0 && polyline) {
        //     cesium.entities.remove(polyline.lineEntity)
        //     for (var j = 0; j < entities.length; j++) {
        //         cesium.entities.remove(entities[j])
        //     }
