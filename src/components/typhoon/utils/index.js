 ...
 * @LastEditTime: 2023-11-17 11:39:18
 * @Description: 
...
export default class Bubble {
    ...
    constructor(val) {
        ...
        this.position = val.info.properties.tyCartesian;
        delete val.info.properties['tyCartesian']
        ...
        this.vmInstance = this.app.mount(node)
